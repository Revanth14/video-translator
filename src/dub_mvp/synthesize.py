    ...
    def run(
        ...
        *,
        ...
        synthesized = [
            ...
            for segment, artifact, artifact_path, metadata_path in zip(
                localized_segments,
                artifacts,
                artifact_paths,
...
def _synthesized_segment(
    ...
    *,
    ...
    return SynthesizedSegment(
        ...
        target_text=segment.target_text,
        target_text_revision=segment.target_text_revision,
        tts_audio_path=str((run_directory / artifact.audio.path).resolve()),
        tts_duration_ms=artifact.duration_ms,
